...
class VastraFlowOrderBook(Document):
	"""VastraFlow Order Book (VastraFlow Order Book) - a lightweight custom order-entry layer
	...
	def create_sales_order_from_book(self):
		...
		"""
		if self.docstatus != 1:
			frappe.throw(_("Submit this VastraFlow Order Book first."))
