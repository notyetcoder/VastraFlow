...
Both the real order-submission flow (vastraflow_order_book.py) and the
...
only and carry zero price impact. A whole VastraFlow Order Book document
...
def calculate_price(fabric, sublimation_type):
	...
	below and by VastraFlowOrderBook.get_price().
	"""
